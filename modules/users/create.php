...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors) {
        ...
        $db->insert("INSERT INTO users (name,email,password,role_id,branch_id,language,is_active) VALUES (?,?,?,?,?,?,?)", [$name,$email,$hash,$role_id,$branch_id,$language,$is_active]);
        Helper::flash('success',"User '$name' created.");
        Helper::redirect(BASE_URL.'/modules/users/index.php');
    }
}

$pageTitle = 'New User';
$breadcrumbs = [['label'=>'Users','url'=>BASE_URL.'/modules/users/index.php'],['label'=>'New']];
require_once ROOT_PATH . '/includes/header.php';
?>
<div class="vp-page-header d-print-none"><h1 class="vp-page-title">New User</h1></div>
  ...
  <div class="col-lg-6">
    <form method="post" class="card vp-card">
      ...
      <div class="card-body">
        ...
        <div class="mb-3"><label class="form-label required">Password</label><input type="password" name="password" class="form-control" placeholder="Min 6 chars"></div>
        <div class="row mb-3">
          <div class="col-md-6">
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-6 d-flex align-items-end">
            <label class="form-check mb-0">
              <input type="checkbox" name="is_active" class="form-check-input" <?= (!isset($_POST['name'])||isset($_POST['is_active']))?'checked':'' ?>>
      ...
      <div class="card-footer d-flex gap-2">
        <button type="submit" class="btn btn-vp-gold">Create User</button>
