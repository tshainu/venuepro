  ...
  <div class="tab-pane fade <?= $active_tab==='halls'?'show active':'' ?>" id="tab-halls" role="tabpanel">
    <div class="card settings-card">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h3>🏛️ Halls</h3>
        <?php if (Auth::hasRole(['super_admin','admin','hall_manager','manager','owner','general_manager'])): ?>
          ...
          <table class="table table-vcenter vp-table mb-0">
            <thead>
              <tr>
                ...
                <th>Rate / Night</th>
                <th>Status</th>
                <?php if (Auth::hasRole(['super_admin','admin','hall_manager','manager','owner','general_manager'])): ?><th></th><?php endif; ?>
              </tr>
            </thead>
            <tbody>
