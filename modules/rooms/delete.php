...
Auth::check();
if (!Auth::hasRole(['super_admin','admin','hall_manager','manager','owner','general_manager'])) { Helper::flash('error', Lang::t('access_denied')); Helper::redirect(($_GET['return']??'')==='settings' ? BASE_URL.'/modules/settings/index.php?tab=rooms' : BASE_URL.'/modules/rooms/index.php'); }
