...
<nav class="sa-nav">
  ...
  <div class="sa-nav-right">
    ...
    <a href="<?= BASE_URL ?>/sa-logout.php" class="btn-sa-logout">Logout</a>
  </div>
</nav>
  ...
  <div class="biz-list">
    ...
    <div class="biz-card status-<?= $b['status'] ?> plan-<?= $b['plan'] ?>">
      ...
      <div class="biz-actions">
        ...
        <?php else: ?>
        <a href="sa-action.php?id=<?= $b['id'] ?>&act=activate" class="btn-icon" title="Activate" onclick="return confirm('Activate this business?')">
          <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg>
        </a>
        <?php endif; ?>
        <a href="sa-action.php?id=<?= $b['id'] ?>&act=delete" class="btn-icon danger" title="Delete" onclick="return confirm('Permanently delete this business?')">
...
<div class="modal-overlay" id="addModal">
  <div class="modal-box">
    ...
    <form method="POST" action="sa-create.php">
    <div class="modal-body">
      <div class="form-row">
        <div class="form-group">
          <label>Business Name *</label>
